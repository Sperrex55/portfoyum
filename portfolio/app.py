...
# Environment değişkenlerinden al, yoksa varsayılan kullan
...
with app.app_context():
    db.create_all()
    if not Admin.query.filter_by(kullanici_adi="sperrex").first():
        yeni_admin = Admin(
            kullanici_adi="sperrex",
            email="ardairmak5555@gmail.com",
            sifre=generate_password_hash("admin5521")
        )
